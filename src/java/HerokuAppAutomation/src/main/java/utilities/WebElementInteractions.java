...
public class WebElementInteractions {
    ...
    public static boolean isElementEnabledUtil(WebElement element) {
        try {
            return element.isEnabled();
        } catch (StaleElementReferenceException ex) {
            System.out.println("Cannot check if element is enabled due to StaleElementReferenceException");
            return false;
        }
    }
